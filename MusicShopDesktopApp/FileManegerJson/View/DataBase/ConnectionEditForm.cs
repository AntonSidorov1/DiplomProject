...
namespace FileManegerJson
{
    public partial class ConnectionEditForm : Form
    {
        ...
        public ConnectionEditForm(ConnectionDataBase dataBase):this()
        {
            ConnectionDataBase = dataBase.CopyWithFull();
        }
        ...
        {
            get => connectionDataBase;
            set => connectionDataBase = value;
        }
        ...
        {
            ConnectionDataBase connectionRythm = ConnectionDataBase.CopyWithFull();
        ...
        private void buttonConnectionRun_Click(object sender, EventArgs e)
        {
            try
            {
                connectionDataBase = new ConnectionDataBase(textBoxConnectionString.Text);
                doMessage();
                ConnectionCopy();
            }
            catch
        ...
        void MakeConnection()
        {
            ...
            ConnectionDataBase = new ConnectionDataBase(connectionRythm);
        }

        private void buttonCheckConnection_Click(object sender, EventArgs e)
        {
            ConnectionDataBase connectionRythm = new ConnectionDataBase(connectionDataBase);
