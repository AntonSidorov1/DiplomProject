...
namespace FileManegerJson
{
    public partial class SupplierEditForm : Form
    {
        ...
        public SupplierEditForm(ProductParameter organization):this()
        {
        ...
        {
            SupplierEditForm form = new SupplierEditForm(organization);
        ...
        {
            SupplierFile organization = new SupplierFile(Organization);
            bool yes = false;
            ...
            if(disk.Choosen)
            {
                try
                {
                    ...
                    if (fileClass.IsSupplier)
                        Organization = fileClass.AsSupplier.Content;
                }
                catch
                {
