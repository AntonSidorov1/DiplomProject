...
public class ApiClient
{
    ...
    public static float DoubleFromJson(String res, String punkt, String Pole) throws JSONException {
    ...
    public static float DoubleFromJsonObject(String res, String Pole) throws JSONException {
        try {            JSONObject doc = new JSONObject(res);
            JSONObject curr = doc;
            return (float) curr.getDouble(Pole);
        }
    ...
    public static Bitmap BitmapFromJsonObject(String res, String Pole) throws JSONException {
        try {
    ...
    public static Bitmap BitmapFromJsonObject(JSONObject res, String Pole) throws JSONException {
        return BitmapFromJsonObject(res.toString(), Pole);
    }

    public static  int IntFromJsonObject(String res, String Pole) throws JSONException {
        try {            JSONObject doc = new JSONObject(res);
            JSONObject curr = doc;
    ...
    public static String StringFromJson(String res, String punkt, String Pole) throws JSONException {
        try {            JSONObject doc = new JSONObject(res);
            JSONObject curr = doc.getJSONObject(punkt);
    ...
    public static String StringFromJsonObject(String res, String Pole) throws JSONException {
        try {            JSONObject doc = new JSONObject(res);
            JSONObject curr = doc;
            return curr.getString(Pole);
        }
    ...
    public class NetOp implements Runnable
    {
        ...
        public void run()
        {
            ...
            catch (Exception ex)
            {
                if(StopFail) {
                    try {
                        Thread.sleep(UsersHelper.GetRandomNumberMilliSeconds());
    ...
    public void POST(String address, Boolean authorization)
    {
